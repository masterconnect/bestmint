  ...
  return (
    <div className="space-y-4">
      <Panel title="Original text">
        <textarea value={text} onChange={(e) => setText(e.target.value)} className={textareaCls("min-h-[180px]")} placeholder="Paste text to rewrite in a different tone…" />
